                ...
                div [classList [("row", True),("request", True)]]
                  [ 
                    ...
                    [
                      ...
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Engineer ", text x.author] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Start Time ", text x.startTime] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "End Time ", text x.endTime] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Equipment ", text x.equipment] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Location ", text x.location] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Job Description ", text x.quote] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Parts Used ",    text x.partsUsed] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Materials Used ", text x.materialsUsed] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Further Action ", text x.furtherAction] ]
                      , div [] (List.map (\(y, z) ->

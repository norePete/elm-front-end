                ...
                div [classList [("row", True),("request", True)]]
                  [ 
                    ...
                    [
                      ...
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Equipment___ ", text x.equipment] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Location____ ", text x.location] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Job_Desc____ ", text x.quote] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Parts_Used__ ",    text x.partsUsed] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Materials___ ", text x.materialsUsed] ]
                      , div [class "row"][ blockquote [style "font-size" "24px", style "width" "80%"][text "Further_____ ", text x.furtherAction] ]
                      , div [] (List.map (\(y, z) ->
